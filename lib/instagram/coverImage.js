...
// mucho de los costados — el auto se veía "zoomeado". Ahora se arma en
// dos capas con sharp (sin pasar por Satori, no hace falta para esto):
//   1) Fondo: la misma foto estirada a todo el canvas y bien difuminada +
//      oscurecida, sólo para rellenar el espacio sobrante con algo del
//      mismo auto y su ambiente, en vez de negro sólido.
//   2) Primer plano: la foto ENTERA sin recortar (encogida si hace falta
//      para que entre, pero nunca cortada), centrada arriba del fondo.
// Así se ve el auto completo, sin recorte de más, y sin franjas negras.
